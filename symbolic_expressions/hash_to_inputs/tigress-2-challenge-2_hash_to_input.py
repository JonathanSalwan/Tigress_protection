...
ref_30085 = ((sx(0x40, ref_30083) * sx(0x40, ref_30077)) & 0xFFFFFFFFFFFFFFFF) # IMUL operation
...
ref_101421 = (((0x0) << 64 | ref_101393) / (((((((((0x0 & 0xFF)) << 8 | (0x0 & 0xFF)) << 8 | (0x0 & 0xFF)) << 8 | (0x0 & 0xFF)) << 8 | (0x0 & 0xFF)) << 8 | (0x0 & 0xFF)) << 8 | (0x0 & 0xFF)) << 8 | (0x7 & 0xFF))) # DIV operation
...
ref_112301 = (((0x0) << 64 | ref_112273) / (((((((((0x0 & 0xFF)) << 8 | (0x0 & 0xFF)) << 8 | (0x0 & 0xFF)) << 8 | (0x0 & 0xFF)) << 8 | (0x0 & 0xFF)) << 8 | (0x0 & 0xFF)) << 8 | (0x0 & 0xFF)) << 8 | (0x7 & 0xFF))) # DIV operation
...
s.add(ref_113750 == int(sys.argv[1]))
collisions = 0
