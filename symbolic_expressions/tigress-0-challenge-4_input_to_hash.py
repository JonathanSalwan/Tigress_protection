...
if ref_33842 == 0x1:
    ...
    ref_81818 = ((sx(0x40, ref_81816) * sx(0x40, 0x3C8E8C76)) & 0xFFFFFFFFFFFFFFFF) # IMUL operation
    ...
    ref_85976 = ((sx(0x40, ref_85974) * sx(0x40, ref_85970)) & 0xFFFFFFFFFFFFFFFF) # IMUL operation
    ...
    ref_121831 = (ref_87180 & 0xFF) # MOVZX operation
    ...
    ref_124726 = ((ref_124724 & 0xFF) & 0xFF) # Byte reference - MOV operation
    ref_126263 = (ref_121900 & 0xFF) # MOVZX operation
    ref_126332 = (ref_126263 & 0xFF) # MOVZX operation
    ref_126334 = ((ref_126332 & 0xFF) & 0xFF) # Byte reference - MOV operation
    ref_131486 = (((((ref_108186 & 0xFF)) << 8 | (ref_108187 & 0xFF)) << 8 | (ref_108188 & 0xFF)) << 8 | (ref_108189 & 0xFF)) # MOV operation
    ref_131559 = (ref_131486 & 0xFFFFFFFF) # MOV operation
    ref_134480 = (((((ref_108182 & 0xFF)) << 8 | (ref_108183 & 0xFF)) << 8 | (ref_108184 & 0xFF)) << 8 | (ref_108185 & 0xFF)) # MOV operation
    ...
    ref_143795 = (((((((((ref_124726 & 0xFF)) << 8 | (ref_87181 & 0xFF)) << 8 | (ref_87182 & 0xFF)) << 8 | (ref_87183 & 0xFF)) << 8 | (ref_87184 & 0xFF)) << 8 | (ref_87185 & 0xFF)) << 8 | (ref_87186 & 0xFF)) << 8 | (ref_126334 & 0xFF)) # MOV operation
    ref_144718 = (((((((((ref_140943 & 0xFF)) << 8 | (ref_140944 & 0xFF)) << 8 | (ref_140945 & 0xFF)) << 8 | (ref_140946 & 0xFF)) << 8 | (ref_142640 & 0xFF)) << 8 | (ref_142641 & 0xFF)) << 8 | (ref_142642 & 0xFF)) << 8 | (ref_142643 & 0xFF)) # MOV operation
    ...
    ref_147141 = (((((((((ref_124726 & 0xFF)) << 8 | (ref_87181 & 0xFF)) << 8 | (ref_87182 & 0xFF)) << 8 | (ref_87183 & 0xFF)) << 8 | (ref_87184 & 0xFF)) << 8 | (ref_87185 & 0xFF)) << 8 | (ref_87186 & 0xFF)) << 8 | (ref_126334 & 0xFF)) # MOV operation
    ...
    ref_153811 = (((((((((ref_140943 & 0xFF)) << 8 | (ref_140944 & 0xFF)) << 8 | (ref_140945 & 0xFF)) << 8 | (ref_140946 & 0xFF)) << 8 | (ref_142640 & 0xFF)) << 8 | (ref_142641 & 0xFF)) << 8 | (ref_142642 & 0xFF)) << 8 | (ref_142643 & 0xFF)) # MOV operation
