...
if ref_79327 == 0x1:
    ...
    ref_149770 = ((sx(0x40, ref_149768) * sx(0x40, ref_149762)) & 0xFFFFFFFFFFFFFFFF) # IMUL operation
    ...
    ref_184621 = (((((ref_180689 & 0xFF)) << 8 | (ref_180690 & 0xFF)) << 8 | (ref_180691 & 0xFF)) << 8 | (ref_180692 & 0xFF)) # MOV operation
    ref_185163 = (ref_184621 & 0xFFFFFFFF) # MOV operation
    ref_189093 = (((((ref_180685 & 0xFF)) << 8 | (ref_180686 & 0xFF)) << 8 | (ref_180687 & 0xFF)) << 8 | (ref_180688 & 0xFF)) # MOV operation
    ...
    ref_250649 = (((((((((ref_248138 & 0xFF)) << 8 | (ref_248139 & 0xFF)) << 8 | (ref_248140 & 0xFF)) << 8 | (ref_248141 & 0xFF)) << 8 | (ref_243617 & 0xFF)) << 8 | (ref_243618 & 0xFF)) << 8 | (ref_243619 & 0xFF)) << 8 | (ref_243620 & 0xFF)) # MOV operation
