...
.3:
  ...
  %.59 = and i64 %.32, 65535
  %.61 = shl i64 %.31, 16
  %.81 = and i64 %.61, 16646144
  %.87 = and i64 %.61, 4278190080
  %.111 = and i64 %.61, 1095216660480
  %.117 = and i64 %.61, 280375465082880
  ...
  %.21930 = lshr i64 %.165, 56
  %.222 = shl nuw nsw i64 %.21930, 24
  %.278 = or i64 %.217, %.222
  %.279 = sub i64 -5, %.132
  %.280 = and i64 %.279, %.278
  %.281 = add i64 %.135, %.280
