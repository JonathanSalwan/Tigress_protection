...
.3:
  ...
  %.7 = add i64 %.6, 1
  %SymVar_0.not = or i64 %SymVar_0, -561930594
  %.9 = xor i64 %SymVar_0.not, 561930593
  ...
  %.176 = add i64 %.175, 1
  %.176.not = or i64 %.176, -2
  %.178 = xor i64 %.176.not, 1
  %.180 = add i64 %.175, 2
  %.182 = add i64 %.180, %.178
  %.183 = add i64 %.182, 1
  %fold = and i64 %.182, 63
  ...
  %.319 = add i64 %.318, 1
  %.319.not = or i64 %.319, 62
  %.321 = xor i64 %.319.not, 1
  %.325 = add i64 %.318, 3
  %.326 = add i64 %.325, %.321
  %.331 = and i64 %.326, 63
  ...
  %.45125 = lshr i64 %.413, 56
  %.454 = shl nuw nsw i64 %.45125, 24
  %.455 = or i64 %.449, %.454
  %.482 = shl i64 %.413, 32
  ...
  %.54744 = lshr i64 %.509, 56
  %.550 = shl nuw nsw i64 %.54744, 24
  %.551 = or i64 %.545, %.550
  %.578 = shl i64 %.509, 32
  ...
  %.686 = add i64 %.685, 1
  %.686.not = or i64 %.686, -2
  %.688 = xor i64 %.686.not, 1
  %.690 = add i64 %.685, 2
  %.692 = add i64 %.690, %.688
  %.693 = add i64 %.692, 1
  %fold52 = and i64 %.692, 63
  %.702 = xor i64 %fold52, 63
  ...
  %.839.not = or i64 %.839, 62
  %.841 = xor i64 %.839.not, 1
  %.843 = add nsw i64 %.838, 2
  %.845 = add i64 %.843, %.841
  %fold53 = and i64 %.845, 63
  %.856 = xor i64 %fold53, 63
  %.857 = shl i64 %.832, %.856
  %.870 = and i64 %.839, 62
  %.871 = or i64 %.870, 1
  ...
  %.884 = or i64 %.882, 1
  %fold54 = sub i64 0, %.884
  %.894 = and i64 %fold54, 63
  %.895 = shl i64 %.635, %.894
  %.995 = and i64 %.857, %.872
  %.996 = xor i64 %.995, -1
  %.998 = add i64 %.857, 1
