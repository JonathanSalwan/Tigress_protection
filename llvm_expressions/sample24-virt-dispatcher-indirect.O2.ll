; ModuleID = 'llvm_expressions/sample24-virt-dispatcher-indirect.ll'
source_filename = "llvm_expressions/sample24-virt-dispatcher-indirect.ll"
...
.3:
  ...
  br i1 %.146.demorgan, label %.3.endif.endif.endif.endif.if, label %.3.endif.endif.endif.endif.else
...
.3.endif.endif.endif.endif.if:                    ; preds = %.3
  ...
  %.235 = and i64 %1, 65280
  %2 = shl i64 %.87, 16
  %.257 = and i64 %2, 4278190080
  %.263 = and i64 %.82, 9223372032576520192
  %.268 = or i64 %.263, %.235
  %.273 = or i64 %.268, %.257
  %.278 = or i64 %.273, %.225
  %.285 = lshr i64 %.89, 3
...
.3.endif.endif.endif.endif.endif:                 ; preds = %.3.endif.endif.endif.endif.else, %.3.endif.endif.endif.endif.if
  %.305.sink.off0 = phi i64 [ %.305, %.3.endif.endif.endif.endif.if ], [ %.392, %.3.endif.endif.endif.endif.else ]
  ret i64 %.305.sink.off0
}
